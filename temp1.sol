...
contract LiquidationOperator is IUniswapV2Callee {
    ...
    address constant targe_lq = 0x59CE4a2AC5bC3f5F225439B2993b86B42f6d3e9F;
    address constant LENDING_POOL = 0x7d2768dE32b0b80b7a3454c06BdAc94A69DDc7A9;
    uint256 amt_usdt_loan = 999;
...
// end of custom function
    ...
    function operate() external {
        ...
        (
            ...
            ltv,
            healthFactor
        ) = lendingPool.getUserAccountData(targe_lq);
        ...
        // do the sawp, borrow USDT using ETH as collateral
